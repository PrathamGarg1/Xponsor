...
export default function InfluencerMessages() { // Replace with BrandMessages or InfluencerMessages as needed
                ...
                {conversations.map(conversation => (
                  <div 
                    ...
                    onClick={() => {
                      ...
                      router.push(`/influencer/messages?userId=${conversation.id}`, { scroll: false });
                    }}
                  >
